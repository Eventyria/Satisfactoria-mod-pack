...
craftingTable.addShaped("complicated_steel_mech", <item:immersiveengineering:component_steel> * 1, [
    [<item:thermal:steel_plate>, <item:createaddition:zinc_sheet>, <item:thermal:steel_plate>],
...
// Steel sheets
<recipetype:create:pressing>.addRecipe("steel_sheets", [<item:thermal:steel_plate>, <item:immersiveengineering:nugget_steel> % 45], <item:immersiveengineering:ingot_steel>);